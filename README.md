...
Then, uncomment the SSL Section on `app/Dockerfile` (make sure that the certificate file names are the same as in the Dockerfile). Also uncomment the HTTPS Port on `docker-compose.yml`.  
